class Talking extends Phaser.Scene {
    ...
    create() {
        ...
        this.Flygon = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'Flygon').setOrigin(0, 1)
        this.Kricketune = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'Kricketune').setOrigin(0, 1)
        this.Bellibolt = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'Bellibolt').setOrigin(0, 1)
